				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
                                                    <%! ArrayList<Categoria> listadoCategorias = CategoriaDal.listarCategoria();%>
                                                    <% for(int i=0; listadoCategorias.size()>i; i++) { %>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="#<%= listadoCategorias.get(i).getCodigo() %>">
											<span class="badge pull-right"><i class="fa fa-plus"></i></span>
											<%= listadoCategorias.get(i).getNombre() %>
										</a>
									</h4>
								</div>
								<div id="<%= listadoCategorias.get(i).getCodigo() %>" class="panel-collapse collapse">
